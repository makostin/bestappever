...
public class CredentialsPrefs {
    ...
    public static final PreferenceString LoginDefault = new PreferenceString( CREDENTIAL_PREFERENCES, LOGIN_DEFAULT_KEY, "user" );
    public static final PreferenceString Login = new PreferenceString( CREDENTIAL_PREFERENCES, LOGIN_KEY );
    public static final PreferenceString PasswordDefault = new PreferenceString( CREDENTIAL_PREFERENCES, PASSWORD_DEFAULT_KEY, "user" );
